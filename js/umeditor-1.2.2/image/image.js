...
//                }
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try{
                var json = eval('('+r+')');
                Base.callback(me.editor, me.dialog, json.file, json.status);
            }catch (e){
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<div class=\"form-group\"><div class=\"col-md-9\"><div class=\"form-control-wrapper\"><input class=\"form-control\" type=\"text\"></div></div>" +
            "<div class=\"col-md-3 pt5\"><div class=\"btn btn-success\"><%=lang_btn_add%></div></div></div>" +
            "</div>" +
        ...
        initContent: function (editor, $dialog) {
            var lang = editor.getLang('image')["static"],
                opt = $.extend({}, lang, {
                    image_url: UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'image/'
                });
