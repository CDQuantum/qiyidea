    ...
    UM.registerWidget( widgetName,{
        ...
        initContent:function( editor, $widget ){
            ...
            var me = this,
                ...
                video_url = UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'video/';
        ...
        createPreviewVideo: function(url){
            ...
            $("#eduiVideoPreview", me.$widget)[0].innerHTML = '<p><embed type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
                ' src="' + url + '"' +
                ' width="' + 420  + '"' +
                ' height="' + 280  + '"' +
                ' wmode="transparent" play="true" loop="false" menu="false" allowscriptaccess="never" allowfullscreen="true" ></embed></p>';
        ...
        createAlignButton: function( ids ) {
            var lang = this.lang,
                vidoe_home = UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'video/';
